...
public class InluirClienteSIACFrame extends JFrame{
		...
		public static void setRotinaExecutada(int rotinaExecutada) {InluirClienteSIACFrame.rotinaExecutada = rotinaExecutada;}

		public InluirClienteSIACFrame()  
		{
